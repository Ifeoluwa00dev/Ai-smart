...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden bg-[url('./assets/images/hero.png')] bg-cover bg-center bg-no-repeat">
      ...
      {/* Navbar */}
      <nav className={`relative z-20 transition-all duration-500 ${scrolled ? 'bg-slate-900/90 backdrop-blur-xl shadow-2xl shadow-black/20' : ''}`}>
          ...
          <div className="flex items-center justify-between py-5">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              <ul className="flex items-center space-x-8">
                {['Home', 'About Us', 'Services','Products', ].map((item) => (
                  <li key={item}>
                    <a
              ...
              <div className="flex items-center space-x-3">
                <button className="px-5 py-2.5 border-2 border-amber-500/50 text-amber-400 rounded-lg hover:bg-amber-500 hover:text-white hover:border-amber-500 transition-all duration-300 text-sm font-semibold backdrop-blur-sm">
                  Contact Us
                </button>
                <button
  ...
  <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
    <div className="bg-[rgb(13,29,44)] w-full max-w-sm rounded-2xl p-6 shadow-2xl animate-[pop_0.25s_ease-out]">
      ...
      <div className="space-y-3">
        ...
        >
          <img src="https://cdn-icons-png.flaticon.com/512/906/906361.png" className="w-6 h-6" />
        ...
        <a
          ...
          className="block bg-slate-800 hover:bg-slate-700 p-3 rounded-xl transition flex items-center gap-3"
        >
          <img src="https://cdn-icons-png.flaticon.com/512/733/733579.png" className="w-6 h-6" />
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden pb-6 animate-fade-in-down">
              ...
              <div className="flex flex-col space-y-3 px-4">
                <button className="w-full px-5 py-2.5 border-2 border-amber-500/50 text-amber-400 rounded-lg hover:bg-amber-500 hover:text-white transition-all duration-300 font-semibold">
                  Contact Us
                </button>
                <button
  onClick={() => setOpenCommunity(true)}
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-6 py-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center space-x-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-full px-5 py-2.5 mb-8 animate-fade-in hover:bg-white/10 transition-all duration-300">
            ...
            <span className="text-gray-300 text-sm font-semibold tracking-wide">Powered by MSDT Model</span>
          </div>
          ...
          {/* Description */}
          <p className="text-gray-400 text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto mb-12 leading-relaxed animate-slide-up-delay">
          Empowering traders with cutting-edge artificial intelligence to maximize returns and minimize risks in dynamic financial markets.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 animate-slide-up-delay-2 mb-20">
            <button className="group px-8 py-4 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-xl font-semibold shadow-2xl shadow-amber-500/30 hover:shadow-amber-500/50 hover:from-amber-600 hover:to-amber-700 transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 w-full sm:w-auto">
